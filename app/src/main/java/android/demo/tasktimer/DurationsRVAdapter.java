...
public class DurationsRVAdapter extends RecyclerView.Adapter<DurationsRVAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.task_durations_items, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        if ((mCursor != null) && (mCursor.getCount() != 0)) {
            ...
            if (viewHolder.description != null) {    // Description is not present in portrait
            ...
            viewHolder.startDate.setText(userDate);
            viewHolder.duration.setText(totalTime);
        }
    }
